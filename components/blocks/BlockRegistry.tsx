...
export const BLOCK_MANIFESTS: Record<string, BlockManifest> = {
  ...
  'card': {
    type: 'card',
    name: 'Cartão',
    description: 'Cartão com imagem, título e texto',
    icon: 'CreditCard',
    category: 'layout',
    validation: [
      { field: 'content.title', type: 'required', message: 'Título do cartão é obrigatório' },
      { field: 'content.text', type: 'required', message: 'Texto do cartão é obrigatório' },
    ],
    defaultProps: {
      type: 'card',
      content: {
  ...
  'list': {
    type: 'list',
    name: 'Lista',
    description: 'Lista de itens com títulos e textos',
    icon: 'List',
    category: 'layout',
    validation: [
      { field: 'content.items', type: 'required', message: 'Lista deve ter pelo menos um item' },
    ],
    defaultProps: {
      type: 'list',
      content: {
  ...
  'icon': {
    type: 'icon',
    name: 'Ícone',
    description: 'Ícone de bibliotecas como Material, FontAwesome, Lucide',
    icon: 'Star',
    category: 'elementos',
    validation: [
      { field: 'content.name', type: 'required', message: 'Nome do ícone é obrigatório' },
    ],
    defaultProps: {
      type: 'icon',
      content: {
  ...
  'quiz-simulation': {
    ...
    name: 'Simulado',
    description: 'Simulado com múltiplas questões e regras de aprovação',
    icon: 'Clipboard',
    category: 'quiz',
    validation: [
      { field: 'content.questions', type: 'required', message: 'Simulado deve ter pelo menos uma questão' },
    ],
    defaultProps: {
      type: 'quiz-simulation',
      content: {
...
export const BLOCK_COMPONENTS: Record<string, React.ComponentType<any>> = {
  ...
  'QuizSimulationBlock': QuizSimulationBlock,
};
